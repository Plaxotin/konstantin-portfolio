...
export const aboutConfig: AboutConfig = {
  label: "ОБО МНЕ",
  description: "Руководитель по цифровой трансформации с 11 годами опыта в капиталоёмких отраслях — горнодобывающая и нефтегазовая промышленность, производство, логистика. Эксперт по стабилизации проектов с высоким уровнем риска, внедрению ERP, MES, APS, BI, AI, OT/SCADA решений.",
  experienceValue: "11+",
  experienceLabel: "ЛЕТ\nОПЫТА",
  stats: [
  ...
  services: [
    {
      ...
      description: "Внедрение ERP, MES, APS, BI, AI, OT/SCADA. Реинжиниринг бизнес-процессов без остановки производства.",
      image: "/images/service-1.jpg",
    },
    {
      iconName: "Layout",
      title: "Управление проектами",
      description: "Стабилизация проектов в кризисе, управление мультивендорными программами. Команды до 200+ специалистов.",
      image: "/images/service-2.jpg",
    },
    {
      iconName: "TrendingUp",
      title: "Операционная эффективность",
      description: "Оптимизация производства и логистики. Результат: +6% производительности, снижение затрат.",
      image: "/images/service-3.jpg",
    },
    {
      iconName: "Users",
      title: "Обучение и менторство",
      description: "Семинары по лидерству, управлению без формальной власти, формированию устойчивых команд.",
