      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-[90vh] lg:min-h-[80vh] px-6 lg:px-12 pt-24 pb-20">
        ...
        >
          <p className="text-base lg:text-xl text-white/70 max-w-3xl">
            Руководитель цифровой трансформации с 11-летним опытом: формирую устойчивые команды, внедряю корпоративные ИТ-решения, реализую масштабные программы и проекты для крупного бизнеса.
          </p>
        </div>
